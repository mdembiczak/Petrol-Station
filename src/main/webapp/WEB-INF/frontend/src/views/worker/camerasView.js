        ...
        return (
            <div>
                ...
                <div className="camerasContainer">
                    <div className="cameraView"><img src={cam1} alt="Cam1"/></div>
                    <div className="cameraView"><img src={cam2} alt="Cam2"/></div>
                    <div className="cameraView"><img src={cam3} alt="Cam3"/></div>
                    <div className="cameraView"><img src={cam4} alt="Cam4"/></div>
                </div>
            </div>
        );
    }
